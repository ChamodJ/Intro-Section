...
const Dropdown = ({items, isOpen, compartment}) => {
  return (
    <div>
      ...
      {/* Desktop */}
      <div className={`${isOpen ? 'sm:absolute hidden' : 'hidden'} py-[15px] px-[25px] leading-[2rem]  ${compartment === 'F' ? 'left-[90px] top-[50px]' : 'left-[290px] top-[50px]'} shadow-2xl rounded-md outline-none border-none sm:absolute`}>
